...
const TeamDetails = () => {
  ...
  return (
    <div className="p-4">
    <div class="font-sans flex flex-col items-center bg-gray-100 p-5">
  <div class="bg-white border border-gray-300 rounded-lg p-5 text-center w-72 mb-5">
  ...
  <div class="w-full max-w-lg">
   <div class="bg-white border border-gray-300 rounded-lg flex justify-between items-center p-3 mb-2">
